...
public class CurrencyConverter {
    private static final String API_URL =
            "https://v6.exchangerate-api.com/v6/a77f0a5c460c8c226988c619/latest/USD";

    public static void main(String[] args) {
        Scanner scanner = new Scanner(System.in);

        System.out.println("Sea bienvenido/a al Conversor de Moneda");
        System.out.println("Obteniendo las tasas de cambio...");

        ExchangeRateResponse ratesData = fetchRates();
        if (ratesData == null) {
            System.err.println("Error al obtener las tasas. Saliendo.");
            return;
        }
        ...
        int option;
        do {
            System.out.println("\nElige la moneda que necesitas convertir: ");
            ...
            if (fromRate == null || toRate == null) {
                System.out.printf("Error: No se encontró tasa de cambio para %s o %s.%n", fromCode, toCode);
                continue;
            }
    ...
    private static ExchangeRateResponse fetchRates() {
